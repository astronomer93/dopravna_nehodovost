...
for(nameDir in nameDirs)
{
	...
	for(traffic in trafficName)
	{
		...
		scale_color_manual(values=c("pointColor"="blue")) +						scale_linetype_manual("",values=c("2010-2012"="dashed","2011-2013"="dashed","2012-2014"="dashed","2013-2015"="dashed","2014-2016"="dashed"),guide=guide_legend(override.aes = list(colour=c("red","orange","yellow","green","violet")))) +
		guides(color=F) +
