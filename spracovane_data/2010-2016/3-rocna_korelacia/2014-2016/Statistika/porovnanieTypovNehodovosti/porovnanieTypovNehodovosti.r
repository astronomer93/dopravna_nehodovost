...
for(nameDir in nameDirs)
{
	...
	for(traffic in trafficName)
	{
		...
		nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2016/','3-rocna_korelacia/2014-2016/Data/',nameDir,'/',traffic,'/korelacia/',nameFile)	
		nameFilePath <- paste(nameFilePath,collapse="")
		nameFilePath1 <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2016/','3-rocna_korelacia/2014-2016/Data/',nameDir,'/',traffic)	
		nameFilePath1 <- paste(nameFilePath1,collapse="")	
		file.move(nameFilePath,nameFilePath1)
		setwd('..')

		nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2016/','3-rocna_korelacia/2014-2016/Data/',nameDir,'/',traffic,'/',nameFile)	
		nameFilePath <- paste(nameFilePath,collapse="")	
		nameFilePath1 <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2016/','3-rocna_korelacia/2014-2016/Data/',nameDir,'/')	
		nameFilePath1 <- paste(nameFilePath1,collapse="")	
		file.move(nameFilePath,nameFilePath1)
		setwd('..')	
	}
	...
	nameFile <- c('porovnanie',cosmicColumnName[cosmicCount],'.csv')
	nameFile <- paste(nameFile,collapse='')
	nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2016/','3-rocna_korelacia/2014-2016/Data/',nameDir,'/',nameFile)	
	nameFilePath <- paste(nameFilePath,collapse="")
