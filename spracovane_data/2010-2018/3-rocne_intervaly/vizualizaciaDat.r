...
for(nameDir in nameDirs)
{
	...
	for(traffic in trafficName)
	{
		...
		xlab("1-156, 2-157, 3-158... weeks") + 
		ylab("Correlation") + 
		geom_vline(aes(xintercept=1,linetype="2010-2012"),color="red",show.legend=T) +
		geom_vline(aes(xintercept=53,linetype="2011-2013"),color="orange",show.legend=T) +
		geom_vline(aes(xintercept=105,linetype="2012-2014"),color="yellow",show.legend=T) +
		geom_vline(aes(xintercept=157,linetype="2013-2015"),color="green",show.legend=T) +
		geom_vline(aes(xintercept=209,linetype="2014-2016"),color="violet",show.legend=T) +
		geom_vline(aes(xintercept=261,linetype="2015-2017"),color="grey",show.legend=T) +
		geom_vline(aes(xintercept=313,linetype="2016-2018"),color="black",show.legend=T) +
		scale_color_manual(values=c("pointColor"="blue")) +						scale_linetype_manual("",values=c("2010-2012"="dashed","2011-2013"="dashed","2012-2014"="dashed","2013-2015"="dashed","2014-2016"="dashed", "2015-2017"="dashed", "2016-2018"="dashed"),guide=guide_legend(override.aes = list(colour=c("red","orange","yellow","green","violet","grey","black")))) +
		guides(color=F) +
