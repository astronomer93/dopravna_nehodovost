declare -a nameDir=("Ap_index" "Dst_index" "Kp_index" "Lyman_alpha_index" "R_sunspot_number" "Solar_index_F10.7" "Proton_flux_over_10_MeV" "Proton_flux_over_30_MeV" "Proton_flux_over_60_MeV" "Solar_wind_temperature" "Solar_wind_density" "Solar_wind_speed" "Polar_cap_north" "Polar_cap_south")
declare -a firstColumnName=("Ap" "Dst" "Kp" "Lyman" "Sunspot" "Solar" "Proton10" "Proton30" "Proton60" "Temperature" "Density" "Speed" "PCN" "PCS")
declare -a twoColumnName=("Ap" "Dst" "Kp" "Lyman" "Sunspot" "Solar" "Proton10" "Proton30" "Proton60" "Temperature" "Density" "Speed" "PCN" "PCS")

declare -a typeTraffic=("celkova_nehodovost" "zraneni" "usmrteni")
declare -a valueTraffic=("Nehodovost" "Zraneni" "Usmrteni")


for countParameter in {0..13} 
do
	...
	do
		...
		do
			...
			echo "Week;${valueTraffic[$trafficCount]};${twoColumnName[$countParameter]};" >> statistika${rok}.csv
