...
for(traffic in trafficName)
{
	...
	for(rok in 2010:2018)
	{
		...
		{	
			...
			nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','1-rocna_korelacia/Data/',parameter,'/',traffic,'/korelacia/',nameFile)	
			nameFilePath <- paste(nameFilePath,collapse="")
			nameFilePath1 <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','1-rocna_korelacia/Data/',parameter,'/',traffic)	
			nameFilePath1 <- paste(nameFilePath1,collapse="")	
			file.move(nameFilePath,nameFilePath1)
			setwd('..')

			nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','1-rocna_korelacia/Data/',parameter,'/',traffic,'/',nameFile)	
			nameFilePath <- paste(nameFilePath,collapse="")
			nameFilePath1 <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','1-rocna_korelacia/Data/',parameter)	
			nameFilePath1 <- paste(nameFilePath1,collapse="")	
			file.move(nameFilePath,nameFilePath1)
			setwd('..')

			nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','1-rocna_korelacia/Data/',parameter,'/',nameFile)	
			nameFilePath <- paste(nameFilePath,collapse="")
