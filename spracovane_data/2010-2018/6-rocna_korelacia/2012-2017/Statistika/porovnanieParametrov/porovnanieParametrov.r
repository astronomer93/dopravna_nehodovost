...
for(traffic in trafficName)
{
	...
	{	
		...
		nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','6-rocna_korelacia/2012-2017/Data/',parameter,'/',traffic,'/korelacia/',nameFile)	
		nameFilePath <- paste(nameFilePath,collapse="")
		nameFilePath1 <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','6-rocna_korelacia/2012-2017/Data/',parameter,'/',traffic)	
		nameFilePath1 <- paste(nameFilePath1,collapse="")	
		file.move(nameFilePath,nameFilePath1)
		setwd('..')

		nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','6-rocna_korelacia/2012-2017/Data/',parameter,'/',traffic,'/',nameFile)	
		nameFilePath <- paste(nameFilePath,collapse="")
		nameFilePath1 <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','6-rocna_korelacia/2012-2017/Data/',parameter)	
		nameFilePath1 <- paste(nameFilePath1,collapse="")	
		file.move(nameFilePath,nameFilePath1)
		setwd('..')

		nameFilePath <- c('/home/astronomer93/dopravna_nehodovost/spracovane_data/2010-2018/','6-rocna_korelacia/2012-2017/Data/',parameter,'/',nameFile)	
		nameFilePath <- paste(nameFilePath,collapse="")
